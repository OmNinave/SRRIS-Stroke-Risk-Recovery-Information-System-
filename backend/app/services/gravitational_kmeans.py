...
class GravitationalKMeans:
    ...
    def fit_incremental(self):
        ...
        while remaining_samples_indices:
            ...
            # Type guard: the inner loop always sets both variables when remaining_samples_indices
            # is non-empty, but we assert here to satisfy static analysis and surface bugs early.
            assert selected_sample_index is not None and selected_cluster_index is not None, \
                "Selection loop failed to pick a sample — remaining_samples_indices was unexpectedly empty."
