    ...
    const fetchData = async () => {
      try {
        ...
        const [trendsRes, benchmarksRes] = await Promise.all([
          fetch(`${API_BASE}/analytics/patient/${patientUid}/trends`, { headers }),
          fetch(`${API_BASE}/analytics/patient/${patientUid}/benchmarks`, { headers })
        ]);
        ...
        // Silent fail — analytics is supplementary, not critical
      } finally {
        setLoading(false);
      }
    };
